...
#Busca em Profundidade
def busca_profundidade(fronteira):
    if not fronteira:
        return None
    #remove o proximo elemento da fronteira (Busca em profundidade - LIFO)
    #print('FRONTEIRA')
    #pprint(fronteira)
    nodo = fronteira.pop(len(fronteira)-1)
